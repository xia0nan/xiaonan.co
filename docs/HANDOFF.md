...
Content update: the owner's [Agoda NLP article](https://medium.com/agoda-engineering/from-tf-idf-to-prompt-based-learning-agodas-nlp-applications-2dfe8abd942a) is now configured as a published, featured external entry dated 2022-10-12. It appears on Home and Writing and links directly to Medium in RSS; no local article page or sitemap URL is generated. Earlier empty-Writing/RSS observations below describe historical checkpoints.
